...
```javascript
import dlastIndexOf from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-ndarray-dlast-index-of@v0.1.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-ndarray-dlast-index-of/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/blas-ext-base-ndarray-dlast-index-of/actions/workflows/test.yml?query=branch:v0.1.1
